...
import WorkingDaysDataTable from '../../parts/workingDays/WorkingDaysDataTable';
import PageTitle from '../../components/other/PageTitle';
import BarChartStat from '../../components/stats/BarChartStat';
import RecentSession from '../../parts/session/RecentSession';
...
export default function Home() {
  return (
    <Layout>
      <PageTitle
        pageTitle="session"
        pageIcon={<EventNoteIcon color="primary" sx={{ fontSize: '40px' }} />}
      />
